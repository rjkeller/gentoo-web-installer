<?php
/** CODE FROM PHPTail Project: https://code.google.com/p/php-tail/ */
	...
	public function generateGUI() {
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="results" style="background:black;color: white;font-family: Courier New;font-size: 0.6em;padding: 5px;border: 1px solid #ccc;">
				</div>
			</body> 
		</html> 
 		<?php
