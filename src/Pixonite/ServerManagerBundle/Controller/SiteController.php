...
use Pixonite\ServerManagerBundle\Entity\Site;
use Pixonite\ServerManagerBundle\Form\SiteType;
...
class SiteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PixoniteServerManagerBundle:Site')->findAll();
     ...
     *
     * @Route("/site", name="site_create")
     * @Method("POST")
     * @Template("PixoniteServerManagerBundle:Site:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('site_show', array('id' => $entity->id)));
        }
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PixoniteServerManagerBundle:Site')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new SiteType(), $entity, array(
            'action' => $this->generateUrl('site_update', array('id' => $entity->id)),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/site/{id}", name="site_update")
     * @Method("PUT")
     * @Template("PixoniteServerManagerBundle:Site:edit.html.twig")
     */
     ...
     *
     * @Route("/site/{id}", name="site_delete")
     * @Method("DELETE")
     */
